        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (pictureBox2.Image != null)
                {
                    ...
                    par.Add("\n");
                    double taxaPermeabilidade = 100 - ((Convert.ToDouble(textBox2.Text) + Convert.ToDouble(textBox5.Text) + (Convert.ToDouble(textBox6.Text)/2) + Convert.ToDouble(textBox7.Text)) / Convert.ToDouble(textBox1.Text)) * 100;
